...
5. Derive the following from the above:
   - **PR title** — short (under 70 chars), imperative tense, and must use Conventional Commits format (e.g. `feat: add JWT auth and magic link login flow`)
...
- PR title must start with one of: `feat:`, `fix:`, `chore:`, `docs:`, `refactor:`, `style:`, `test:`, `perf:`
